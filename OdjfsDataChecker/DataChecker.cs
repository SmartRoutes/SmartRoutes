...
namespace OdjfsDataChecker
{
    public class DataChecker
    {
        ...
        private readonly IChildCareStubListScraper _scraper;

        public DataChecker(IChildCareStubListScraper scraper)
        {
            _scraper = scraper;
        }
        ...
        {
            Logger.Trace("Initializing the OdjfsEntities context.");
            using (var ctx = new OdjfsEntities())
            {
                ...
                ChildCareStub[] webStubs = (await _scraper.Scrape(county)).ToArray();
